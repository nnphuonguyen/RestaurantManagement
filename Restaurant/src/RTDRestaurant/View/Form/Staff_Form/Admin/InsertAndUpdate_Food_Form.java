...
public class InsertAndUpdate_Food_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        if (data == null) {
            ...
            if (data.getState().equals("are trading")) {
            ...
            } else if (data.getState().equals("stop business")) {
                cmdStop.setIcon(new ImageIcon(getClass().getResource("/Icons/selling.png")));
                cmdStop.setText("BUSINESS AGAIN");
