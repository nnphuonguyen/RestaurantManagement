...
public class OrderFood_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        txtSearch.setHint("Search for food . . .");
    ...
    private void initComponents() {
        ...
        orderby.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Name A->Z", "Price Ascending", "Price Descending" }));
        orderby.setSelectedIndex(-1);
        orderby.setToolTipText("Arrange");
