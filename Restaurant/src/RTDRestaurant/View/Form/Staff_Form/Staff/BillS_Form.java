...
public class BillS_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        lbNgHD.setText("Date: " + bill.getNgayHD());
    }
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Invoice information");
        ...
        cmdOK.setText("Payment confirmation");
        ...
        cmdExportBill.setText("Output Bill");
        ...
        lbTiengiam.setText("Discount money");
        ...
        lbTienKH.setText("Money given by guests");
    ...
    private void cmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOKActionPerformed
        try {
            ...
            main.showForm(new TableMenuS_Form("Floor 1", user, main));
    ...
    private void cmdExportBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExportBillActionPerformed
        ...
        String title = "Ora Restaurant";
        String subtitle = "PAY BILL";
        String footer="THANK YOU FOR YOU PURCHASE";
        String NameCus = "";
        try {
            NameCus = serviceS.getTenKH(bill.getIdKH());
        } catch (SQLException ex) {
            Logger.getLogger(BillS_Form.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try {
            ...
            cs.showText("Price: ");
            cs.newLine();
            cs.showText("Discount money: ");
            cs.newLine();
            cs.showText("Total: ");
            cs.newLine();
            cs.showText("Money given by guests: ");
            cs.newLine();
            cs.showText("Refunds: ");
            cs.endText();
