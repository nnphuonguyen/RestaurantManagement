...
public class Main_Customer_Frame extends javax.swing.JFrame {
    ...
    public void init(){
        ...
        menu.addEvent(new EventMenuSelected(){
            ...
            public void menuSelected(int menuIndex, int subMenuIndex)  {
                switch (menuIndex) {
                    ...
                    case 1 -> {
                        switch (subMenuIndex) {
                            case 0 -> main.showForm(new TableMenu_Form("Floor 1",user));
                            case 1 -> main.showForm(new TableMenu_Form("Floor 2",user));
                            case 2 -> main.showForm(new TableMenu_Form("Floor 3",user));
                            default -> {
                            }
                        }
                    }
        ...
        main.showForm(new TableMenu_Form("Floor 1",user));
    }
