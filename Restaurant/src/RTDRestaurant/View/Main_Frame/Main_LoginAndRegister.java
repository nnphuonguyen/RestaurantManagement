...
public class Main_LoginAndRegister extends javax.swing.JFrame {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    if(service.verifyCodeWithUser(user.getUserID(),verifyCode.getInputCode())){
                        ...
                        showMessage(Message.MessageType.SUCCESS, "Sign Up Success");
                        verifyCode.setVisible(false);
                    }else{
                        showMessage(Message.MessageType.ERROR, "Verification code is incorrect");
                    }
                    
                }catch (SQLException e) {
                    showMessage(Message.MessageType.ERROR, "A system error occurred");
                    e.printStackTrace();
                }
            }
        });
    ...
    private void register(){
        ...
        try {
            ...
            e.printStackTrace();
            showMessage(Message.MessageType.ERROR, "Registration error");
