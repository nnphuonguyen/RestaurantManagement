...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        title= new JLabel("Welcome to the restaurant");
        title.setFont(new Font("sansserif",1,18));
        title.setForeground(new Color(245,245,245));
        add(title);
        
        subtitle= new JLabel("Ora Restaurant");
        subtitle.setFont(new Font("sansserif",1,28));
        subtitle.setForeground(new Color(245,245,245));
        add(subtitle);
        
        description = new JLabel("To use the service please click here");
        description.setForeground(new Color(245,245,245));
        add(description);
        
        description1 = new JLabel("Log in with your personal account");
    ...
    private void login(boolean login){
        if(this.isLogin!=login){
            ...
            if(login){
                ...
                title.setText("You don't have an account yet");
                description.setText("Create a new account");
                description1.setText("and start your experience with our restaurant");
                button.setText("Register  >>");
            }else{
                //Set Data cho Panel cover khi ở màn hình đăng ký
                logo.setIcon(new ImageIcon(getClass().getResource("/Icons/logo_register.png")));
                title.setText("Welcome to the restaurant");
                description.setText("To use the service please click here");
                description1.setText("Log in with your personal account");
                button.setText("<<  Log In");
            }
            this.isLogin=login;
        }
