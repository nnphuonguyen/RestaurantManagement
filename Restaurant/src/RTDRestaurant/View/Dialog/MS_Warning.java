...
public class MS_Warning extends javax.swing.JDialog {
    ...
    public void WarningBook() {
        ...
        lbTitle.setText("YOU HAVEN'T BOOKED YOUR TABLE!!!");
        lbMessage.setText("Please reserve a table before ordering.");
        animator.start();
        setVisible(true);
    }
    ...
    public void WarningExchange(int need) {
        setLocationRelativeTo(frame);
        lbTitle.setText("YOU DO NOT HAVE ENOUGH POIN!!!");
        lbMessage.setText("You still lack "+need+" points to redeem this Voucher.");
        animator.start();
        setVisible(true);
    }
    ...
    public void WarningLackofInfo() {
        setLocationRelativeTo(frame);
        lbTitle.setText("LACK OF INFORMATION !!!");
        lbMessage.setText("Please enter all information before proceeding.");
        animator.start();
        setVisible(true);
    }
    ...
    public void WarningFireAdmin() {
        setLocationRelativeTo(frame);
        lbTitle.setText("NOT ENOUGH RIGHTS!!!");
        lbMessage.setText("You do not have enough authority to fire the Manager.");
        animator.start();
        setVisible(true);
    }
