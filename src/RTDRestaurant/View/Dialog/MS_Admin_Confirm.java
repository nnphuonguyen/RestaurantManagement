...
public class MS_Admin_Confirm extends javax.swing.JDialog {
    ...
    public void ConfirmStop(ModelMonAn data) {
        ...
        lbTitle.setText("IS IT CONFIRMED TO STOP BUSINESS ?");
        lbMessage.setText("Are you sure you should stop selling ID items: " + data.getId() + " - " + data.getTitle() + " ?");
        animator.start();
    ...
    public void ConfirmBack(ModelMonAn data) {
        setLocationRelativeTo(frame);
        lbTitle.setText("CONFIRMED TO BE ACTIVE BACK ?");
        lbMessage.setText("Are you sure you can resell the item ID: " + data.getId() + " - " + data.getTitle() + " ?");
        animator.start();
        cmdOK.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void ConfirmFire(ModelNhanVien data) {
        setLocationRelativeTo(frame);
        lbTitle.setText("CONFIRMED LAYOFF OF EMPLOYEES?");
        lbMessage.setText("Are you sure to fire employee ID: " + data.getId_NV() + " - " + data.getTenNV() + " ?");
        animator.start();
        cmdOK.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
