...
public class MS_Confirm extends javax.swing.JDialog {
    ...
    public void Cus_ConfirmBook(ModelBan table, ModelKhachHang customer) {
        ...
        lbTitle.setText("BOOKING CONFIRMATION");
        lbMessage.setText("Are you sure to book table " + table.getName() + "?");
        animator.start();
    ...
    public boolean Staff_ConfirmDelete(ModelNguyenLieu data ){
        ...
        lbTitle.setText("CONFIRMING DELETION OF MATERIALS");
        lbMessage.setText("Are you sure to delete material " + data.getTenNL() + "?");
        animator.start();
        cmdOK.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
