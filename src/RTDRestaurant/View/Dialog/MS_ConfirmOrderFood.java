...
public class MS_ConfirmOrderFood extends javax.swing.JDialog {
    ...
    public void ConfirmOrder(ModelMonAn monan, int soluong,int ID_HoaDon) {
        ...
        lbMessage.setText("Are you sure to order item ("+monan.getTitle()+") in quantity of "+soluong+" ?");
        lbTotal.setText("Total : "+(monan.getValue()*soluong));
        animator.start();
    ...
    private void initComponents() {
        ...
        lbTitle.setText(" ORDER CONFIRMATION");
