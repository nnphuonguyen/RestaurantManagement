...
public class MenuA extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/menu.png")), "Menu Management"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/staff.png")), "Human Resource Management"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/analytics.png")), "Sales Report"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/bill.png")), "Invoice Statistics"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/inventory.png")), "Warehouse Import Statistics"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/customer.png")), "Customer information"));
        addMenu(new ModelMenu(null, ""));
        addMenu(new ModelMenu(null, "Personal information"));
        addMenu(new ModelMenu(null, ""));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/user.png")), "Account"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/logout.png")), "Log Out"));
    }
    ...
    private void initComponents() {
        ...
        logo.setText("<html>Administrator<br> Restaurant ★★★★★</html>");
