...
public class MenuStaff extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/nglieu.png")), "Raw Material Management"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/kho.png")), "Warehouse Information"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/import.png")), "Input Management"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/export.png")), "Output Management"));
