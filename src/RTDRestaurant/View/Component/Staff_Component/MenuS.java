...
public class MenuS extends javax.swing.JPanel {
    ...
    public void initMenuItem() {
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/Icons/MenuBar/table.png")), "Desk manager", "Floor 1", "Floor 2", "Floor 3"));
    ...
    private void initComponents() {
        ...
        logo.setText("<html>Receptionist<br> Restaurant ★★★★★</html>");
