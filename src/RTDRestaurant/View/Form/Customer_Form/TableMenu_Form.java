...
public class TableMenu_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        state.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Available", "Having a meal", "Reserved", " " }));
