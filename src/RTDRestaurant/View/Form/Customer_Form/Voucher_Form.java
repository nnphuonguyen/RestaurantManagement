...
public class Voucher_Form extends javax.swing.JPanel {
    ...
    public void init(){
        ...
        txtSearch.setHint("Search for Vouchers . . .");
    ...
    public void getCustomerAndBill(){
        try {
            ...
            txtPoint.setText(customer.getPoints()+" poin");
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Accumulated points");
        ...
        cbbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Under 300 coins", "Between 300 and 500 coins", "Over 500 coins" }));
        ...
        lbdTL.setText("Your accumulated points");
        ...
        lbVoucher.setText("Change Voucher");
