...
public class Bill_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Invoice history");
        ...
        cbbox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Under 1,000,000 VND", "From 1 to 5,000,000 VND", "Over 5,000,000 VND" }));
        cbbox.setToolTipText("Arrange");
        ...
        lbBill.setText("List of Invoices");
        ...
        tableHD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill ID", "Bill Date", "Money for meals", "Voucher", "Money Reduced", "Total"
            }
        ) {
