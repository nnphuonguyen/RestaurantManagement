...
public class CusInformation_Form extends javax.swing.JPanel {
    ...
    public void init() {
        txtSearch.setHint("Finding customers . . .");
    ...
    public void initTable() {
        try {
            ...
            for (ModelKhachHang data : list) {
                tableKH.addRow(new Object[]{data.getID_KH(), data.getName(), data.getDateJoin(), df.format(data.getSales()) + "đ", data.getPoints() + " poin"});
            }
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Customer information");
        ...
        lbTong.setText("Member customers");
        ...
        lbCus.setText("List of customers");
        ...
        tableKH.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Customer Name", "Date Join", "Sales", "Poin"
            }
        ) {
