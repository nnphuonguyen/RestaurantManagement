...
import RTDRestaurant.View.Form.Staff_Form.WarehouseStaff.*;
...
public class CTNK_Form extends javax.swing.JPanel {
    ...
    public CTNK_Form(ModelPNK pnk, MainForm main) {
        this.main = main;
        this.pnk = pnk;
    ...
    public void init() {
        txtSearch.setHint("Search for ingredients . . .");
        ...
        lbDate.setText("Date input: " + pnk.getNgayNK());
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Details of Warehouse Input");
        ...
        lbPNK.setText("List of ingredients");
        ...
        tableCTNK.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Material ID", "Material Name", "Unit", "Quantity", "Price"
            }
        ) {
