...
public class BillStatistic_Form extends javax.swing.JPanel {
    ...
    public void init() {
        txtSearch.setHint("Search Invoice . . .");
    ...
    public void getRevenue() {
        try {
            txtprofit.setText(df.format(serviceA.getRevenueHD("Today")) + "đ");
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Invoice Statistics");
        ...
        lbprofit.setText("Invoice Revenue during the day");
        ...
        lbCus.setText("List of Invoices");
        ...
        tableHD.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Bill Id", "Customer ID", "Table ID", "Bill Date", "Money for meals", "Money reduced", "Total"
            }
        ) {
        ...
        filter.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Today", "This Month", "This Year" }));
        ...
        cmdCTHD.setText("SEE INVOICE DETAIL");
        ...
        cmdExcel.setText("EXCEL FILE EXPORT");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(cmdCTHD, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void cmdExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdExcelActionPerformed
        ...
        try {
            ...
            workbook.easy_getSheetAt(0).setSheetName("List of Invoices");
