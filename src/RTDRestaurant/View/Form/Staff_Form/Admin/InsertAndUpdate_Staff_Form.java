...
public class InsertAndUpdate_Staff_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        if (data == null) {
            ...
            if(data.getTinhTrang().equals("Working")){
            cmdKick.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    if (data.getChucvu().equals("Manager")) {
            ...
            }else if(data.getTinhTrang().equals("Has retired")) {
                cmdKick.setText("WAS FIRED");
    ...
    private void initComponents() {
        ...
        cbboxCvu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Serve", "Reception", "Cashier", "Kitchen", "House", "Manager" }));
