...
import RTDRestaurant.View.Form.Customer_Form.*;
...
import RTDRestaurant.View.Component.Staff_Component.CardBanS;
...
public class TableMenuS_Form extends javax.swing.JPanel {
    ...
    public void init(){
        try {
            ...
            txtSearch.setHint("Search table . . .");
    ...
    private void initComponents() {
        ...
        state.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Available", "Dine", "Reserved" }));
        state.setToolTipText("Arrange");
