...
public class Import_Form extends javax.swing.JPanel {
    ...
    public void init() {
        txtSearch.setHint("Search for Import . . .");
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Receipt Management");
        ...
        lbTong.setText("Total warehouse receipt today");
        ...
        lbPNK.setText("List of Warehouse Receipts");
        ...
        tablePNK.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Receipt ID", "Employee ID", "Receipt Date", "Total"
            }
        ) {
