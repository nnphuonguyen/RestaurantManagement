...
public class Export_Form extends javax.swing.JPanel {
    ...
    public void init() {
        txtSearch.setHint("Search for Export . . .");
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Export Management");
        ...
        lbSL.setText("Total number of warehouse export today");
        ...
        lbPXK.setText("List of Warehouse Export");
        ...
        tablePXK.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Export ID", "Employee ID", "Date Export"
            }
        ) {
